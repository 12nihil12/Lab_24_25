...
class solver{
    public: 
        ...
        virtual double find_zero(double a,double b, myfun2 * f , double u_prec=0.001 )  =0;
...
class bisezione : public solver {
    public:
    bisezione (): solver() {; }; 
  virtual double find_zero(double a,double b, myfun2 * f , double u_prec=0.001 ) override;
};
