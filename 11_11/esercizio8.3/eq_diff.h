...
class eq_diff{
    public:
     eq_diff(vector <double> x_0, double t_0) { i_t_0= t_0; i_x_0= x_0;}; 
        virtual vector <double>  step(const vector <double> &x, double t, fun_vet_base * f, double h=0.0001) const =0; 
       vector <double>   get_x_0(){return i_x_0;}; 
       double  get_t_0(){return i_t_0;}; 
          void set_x_0(vector <double> x_0){i_x_0=x_0;}; 
       void   set_t_0(double t_0){i_t_0=t_0;}; 
...
class eulero:public eq_diff {
    ...
    eulero(vector <double> x_0, double t_0) : eq_diff(x_0,t_0){;};
        virtual vector <double>  step(const vector <double> &x, double t,fun_vet_base * f,double h=0.0001) const override{
