...
int main(int argc, char** argv) {
   ...
   // TCanvas c("Distribuzioni valori misurati e attesi relativi alla quantita' indicata","Distribuzioni valori misurati e attesi relativi alla quantita' indicata");
    
    //TCanvas d("Hey","Correlazione");
   ...
   */
   ...
   for(int k=0; k<12;k++){
    ...
    cout << "Media e deviazione standard delle differenze tra i valori attesi e misurati per le varie quantita'"<<endl<<endl;
    cout << "Theta_0 |   MEDIA:" << fixed<<  setprecision(7) << hist[0]->GetMean() << "    |   DEV.STD:"  << hist[0]->GetStdDev() << endl;
    ...
    cout << "Delta_1 |   MEDIA:"  << hist[3]->GetMean() << "    |   DEV.STD:"  << hist[3]->GetStdDev() << endl;
    cout << "Delta_2 |   MEDIA:"  << hist[4]->GetMean() << "    |   DEV.STD:"  << hist[4]->GetStdDev() << endl;
    cout << "n_1 |   MEDIA:"  << hist[5]->GetMean() << "    |   DEV.STD:"  << hist[5]->GetStdDev() << endl;
    cout << "n_2 |   MEDIA:"  << hist[6]->GetMean() << "    |   DEV.STD:"  << hist[6]->GetStdDev() << endl;
    cout << "A |   MEDIA:"  << hist[7]->GetMean() << "    |   DEV.STD:"  << hist[7]->GetStdDev() << endl;
    cout << "B |   MEDIA:"  << hist[8]->GetMean() << "    |   DEV.STD:"  << hist[8]->GetStdDev() << endl;
